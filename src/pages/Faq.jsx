...
const Faq = () => {
  return (
    <div>
      <SEO
        title="FAQ - Best Security Guard Service Company"
      ...
      <ContactBanner
        ...
        text={
          <>
            Do you have more questions or need a quote? We're here to help! Feel
            ...
            , give us a call at
            <a href="tel:8665002050" className="text-[#003366] font-bold">
              {" "}
              866-500-2050
            </a>
            , or chat with our 24/7 live support team by clicking the "Chat with
            Us" button on the bottom right. We're ready to assist you in any way
            we can.
          </>
        }
      />
